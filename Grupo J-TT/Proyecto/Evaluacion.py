...
class Evaluacion():
    def __init__(self,VentanaTeoria,NumeroTema):
        ...
        if(NumeroTema==0):
            ...
            self.lblP1=ttk.Label(self.P1,text="Pregunta 1: ¿Cuál de las siguientes definiciones describe un algoritmo? (2p)").pack()
            ...
            self.lblP2=ttk.Label(self.P2,text="Pregunta 2: ¿Cuál de las siguientes opciones se refiere a un método de desarrollo de algoritmos? (2p)").pack()
            ...
            self.lblP3=ttk.Label(self.P3,text="Pregunta 3: Los algoritmos debe terminar después de un número determinado de pasos. (2p)").pack()
            ...
            self.lblP4=ttk.Label(self.P4,text="Pregunta 4: ¿Cuál de los siguientes tipos de algoritmos da una solución inexacta pero dentro de un margen de error preestablecido? (2p)").pack()
            ...
            self.lblP5=ttk.Label(self.P5,text="Pregunta 5: ¿Cuál de las siguientes opciones menciona técnicas usadas para representar algoritmos sin ambigüedades? (2p)").pack()
