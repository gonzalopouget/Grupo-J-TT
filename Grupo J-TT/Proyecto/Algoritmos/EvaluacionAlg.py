...
class Evaluacion():
    def __init__(self,VentanaTeoria):
        ...
        #Dentro de ese frame se agregan la pregunta a responder y las opciones de respuesta
        self.lblP2=ttk.Label(self.P2,text="Pregunta 2: ¿Cuál de las siguientes opciones se refiere\n\ta un método de desarrollo de algoritmos?").pack()
        ...
        #Dentro de ese frame se agregan la pregunta a responder y las opciones de respuesta
        self.lblP3=ttk.Label(self.P3,text="Pregunta 3: Los algoritmos debe terminar después\n\tde un número determinado de pasos.").pack()
        ...
        #Dentro de ese frame se agregan la pregunta a responder y las opciones de respuesta
        self.lblP5=ttk.Label(self.P5,text="Pregunta 5: ¿Cuál de las siguientes opciones menciona técnicas\n\tusadas para representar algoritmos sin ambigüedades?").pack()
